...
{
    public class SetupLocal : Screen, ButtonListener
    {
        private TextField nameField;
        private TextField botsField;
        ...
        public void Clicked(Button button)
        {
            ...
            {
                Screens.ScreenManager.GotoScreen("gameboard", "local", nameField.Text, Int32.Parse(botsField.Text));
            }
        }
    }
}
